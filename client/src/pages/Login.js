            ...
            <div className="row w-25 mx-auto">
                ...
                <form action="/login"  className="w-50 mx-auto mt-5 mb-5 shadow p-3 mb-5 bg-white rounded">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="password" className="form-control" placeholder="Enter password" id="pwd" name="password" onChange={(e) => setPassword(e.target.value)}></input>
                    </div>
                    <div className="d-grid">
                        <button className=" btn btn-primary  btn-sm gap-2" onClick={login}>Login</button>
                    </div>
                </form>
